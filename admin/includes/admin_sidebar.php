...
<aside class="admin-sidebar" id="sidebar" aria-label="Menu administrativo">
    ...
    <nav class="d-flex flex-column gap-1">
        ...
        <a href="<?= adminEsc($urlAdmin) ?>dashboard.php"
        ...
        <a href="<?= adminEsc($urlAdmin) ?>projetos/index.php"
           class="sidebar-link <?= ($diretorioAtual === 'projetos') ? 'active' : '' ?>">
            <i class="bi bi-folder2-open" aria-hidden="true"></i>
            <span>Projetos</span>
        </a>

        <a href="<?= adminEsc($urlAdmin) ?>tecnologias/index.php"
        ...
        <a href="<?= adminEsc($baseUrl) ?>index.php" target="_blank" class="sidebar-link">
            <i class="bi bi-box-arrow-up-right" aria-hidden="true"></i>
            <span>Ver Site</span>
        </a>

        <a href="<?= adminEsc($urlAdmin) ?>auth/logout.php" class="sidebar-link mt-2"
